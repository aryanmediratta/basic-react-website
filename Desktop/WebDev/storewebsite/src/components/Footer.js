      ...
      <div className = "container">
          <div className = "row">
            ...
            <div className = "col s12 m6 l6">
                <ul>
                  <li> 
                  <SocialIcon url="https://www.facebook.com/Delhi-Grill-304409520408653/?modal=admin_todo_tour" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer" network="facebook" style= {h2s} fgColor = "#ffffff" /> 
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
