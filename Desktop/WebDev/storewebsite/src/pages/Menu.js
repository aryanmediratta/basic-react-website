...
class Menu extends Component {
	...
	render(){
		return(
			...
			<div className = 'container'>
			<div class="center">
			 <a className="black-text btn-flat white" href = "#starters"> Starters </a> 
			 <a className="black-text btn-flat white" href = "#breads"> Breads </a>
			 <a className="black-text btn-flat white" href = "#mains"> Main Course </a> 
			 <a className="black-text btn-flat white" href = "#drinks"> Drinks </a> 
			 <a className="black-text btn-flat white" href = "#sweet"> Sweet Dishes </a> 
			 <a className="black-text btn-flat white" href = "#thali"> Thali </a> 
			 </div>
			 </div>
			 <br/>

			<div class="center">
			 <a className="black-text btn-flat white" href = "https://www.foodpanda.my/restaurant/m7ah/delhi-grill-brickfield" target = "_blank" rel="noopener noreferrer">Order From Us on Foodpanda! </a>
			</div>
			<br/>
			<div class="center">
			<a class="btn-flat black-text white" href="tel:60169560954" target="_blank"><i class="material-icons left">phone</i>+6016-9560954</a>			
		 </div>
